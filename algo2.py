...
##############################################################################
    ...
    algo.schedule_function(func=rebalance,
                           ...
                           #week_start reemplazado por every_day
                           #con la intención de cumplir la restricción Turnover
                           #explicado a mayor detalle anteriormente
...
##############################################################################
    ...
    # estos son los factores adicionales elegidos
    ...
    # se hace uso de literales a,b,c... por facilidad al momento de hacer pruebas
    ...
    e = Fundamentals2.total_yield.latest
    #f = Fundamentals.cf_yield.latest
    #g = Fundamentals.
...
##############################################################################
    ...
    #estos tres factores iniciales son los del ejemplo, no se usan porque no
    #resultaron convenientes. Se obtuvieron retornos poco atractivos al usarlos
    
        #(-0.1*value_winsorized.zscore() )+
        #(-1.1*quality_winsorized.zscore() )+
        #(1*sentiment_score_winsorized.zscore())
        
    #factores elegidos para este ejemplo, explicación de los factores más adelante
    ...
    #el último factor: basic average share, viene del Sentdex News Sentiment
    #era un dataset premium que ahora es gratuito. Sin embargo, al tratar de
    #usarlo, se obtuvieron resultados parecidos al sentiment score del ejemplo
    #por lo que no resultó conveniente su uso
...
##############################################################################   
 #al modificar la fracción que multiplica a TOTAL_POSITIONS, se consiguió un
 #mejor desempeño que con las fracciones del ejemplo: 1/2 y 1/2.
 #también da buen resultado usar las fracciones 1/3 y 2/3, respectivamente
